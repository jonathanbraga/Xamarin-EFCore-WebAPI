...
namespace VanEscolar.Data.Migrations
{
    ...
    [Migration("20171230193112_AuthMessageFixed")]
    partial class AuthMessageFixed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VanEscolar.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VanEscolar.Domain.Student", b =>
                {
                    ...
                    b.Property<Guid?>("TravelStudentId");
                    ...
                    b.HasIndex("TravelStudentId")
                        .IsUnique()
                        .HasFilter("[TravelStudentId] IS NOT NULL");
            ...
            modelBuilder.Entity("VanEscolar.Domain.TravelStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VanEscolar.Domain.Student", b =>
                {
                    ...
                    b.HasOne("VanEscolar.Domain.TravelStudent", "TravelStudent")
                        .WithOne("Student")
                        .HasForeignKey("VanEscolar.Domain.Student", "TravelStudentId");
                });
            ...
            modelBuilder.Entity("VanEscolar.Domain.Travel", b =>
                {
                    b.HasOne("VanEscolar.Domain.TravelStudent", "TravelStudent")
                        .WithOne("Travel")
                        .HasForeignKey("VanEscolar.Domain.Travel", "TravelStudentId");
                });
